...
y_pred_unseen = svm_classifier.predict(X_unseen)
...
plt.title('SVM ROC Curve - Training Data')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('SVM ROC Curve - Testing Data')
plt.legend(loc="lower right")
plt.show()
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('SVM ROC Curve - Unseen Data')
plt.legend(loc="lower right")
plt.show()
